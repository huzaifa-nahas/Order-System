...
let vidoSubscription = new Product(1, ItemType.subscription, BookOrVideo.video, 15.60, "video subscription");
let harryBook = new Product(2, ItemType.oneTime, BookOrVideo.book, 8.50, "Harry Potter and the Goblet of Fire");
let videoMission = new Product(3, ItemType.oneTime, BookOrVideo.video, 4.50, "Mission Impossible");
